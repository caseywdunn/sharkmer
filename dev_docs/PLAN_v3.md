...
> Historical archive, preserved on 2026-09-08. This document describes past
> development sessions, including approaches later removed or replaced. Its
> checked boxes are not a specification of the current executable. See
> [PLAN.md](PLAN.md) for the active execution plan and release gates.
