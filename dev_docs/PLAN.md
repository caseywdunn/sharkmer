...
- [ ] [#129](https://github.com/caseywdunn/sharkmer/issues/129) — Make sPCR validation and benchmark provenance trustworthy.
  ...
  - [ ] Audit and distinguish deposited reference regions from bootstrap amplicons carrying BLAST-hit accession labels. The 2026-09-13 public-record check finds the 978 bp panel ITS_2 labeled AK281180 is not the 256 bp deposited record, and hydrozoa EU293971.1 has a one-base discrepancy. Exact assembly-to-bootstrap agreement is not independent full-product biological confirmation. Preserve provenance, coordinates/strand, alignment extent, and source type; see [the reference assessment](BENCHMARK_reference_gates.md#reference-provenance-discovery).
