...
fn get_preconfigured_panels() -> Vec<PCRPanel> {
    let mut panels = vec![
        ...
        PCRPanel {
            ...
            description: "universal primer set".to_string(),
            params: get_angiospermae(),
        },
        PCRPanel {
            name: "insecta".to_string(),
            description: "several primer sets".to_string(),
            params: get_insecta(),
        },
    ];
